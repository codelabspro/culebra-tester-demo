...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'culebrastore.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'culebrastore.UserRole'
grails.plugin.springsecurity.authority.className = 'culebrastore.Role'
